...
| Source     | df | SS     | MS     | F    |
|------------|----|--------|--------|------|
| Regression | 1  | 39880.814| 39880.814 | 6.46 |
| Error      | 16 | 21046.6715| 1315.417|      |
| **Total**      | **17** | **60927.4855**|        |      |
...
$$
SST =  \sum_{i=1}^{3} \frac{T_i^2}{n_i} - CM = \frac{850.8^2}{9} +\frac{14.1^2}{9} - 40570.236 = 39880.814
$$

### Step6 Find SSE (sum of squares for error)

$$
SSE = Total \ SS - SST = 60927.4855- 39880.814= 21046.6715
$$
...
$$
MST = \frac{SST}{k-1} = \frac{39880.814}{1} = 39880.814
$$

$$
MSE = \frac{SSE}{n-k} = \frac{21046.6715}{16} = 1315.417
$$

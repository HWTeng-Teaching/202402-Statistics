...
$$= P\left(-t_{n-1;\alpha/2}S_d / \sqrt{n} <  (\mu_1 - \mu_2) - \bar{D} < t_{n-1;\alpha/2}S_d / \sqrt{n}\right)$$

$$= P\left(\bar{D} - t_{n-1;\alpha/2}S_d / \sqrt{n} < (\mu_1 - \mu_2) < \bar{D} + t_{n-1;\alpha/2}S_d / \sqrt{n}\right)$$

$$\bar{D} - t_{n-1;\alpha/2}S_d / \sqrt{n} < (\mu_1 - \mu_2) < \bar{D} + t_{n-1;\alpha/2}S_d / \sqrt{n}$$

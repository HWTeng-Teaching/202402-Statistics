...
3. | the number of completed passes | sample | rank |
   ...
   $\mu_{T}$ = $\frac{{n<sub>1</sub>}({n<sub>1</sub>}+{n<sub>2</sub>}+1)}{2}$  
             = $\frac{15(15+16+1)}{2}\$ = 240  
   $\sigma_{T}$<sup>2</sup> = $\frac{{n<sub>1</sub>}{n<sub>2</sub>}({n<sub>1</sub>}+{n<sub>2</sub>}+1)}{12}$  
             = $\frac{15*16(15+16+1)}{12}\$ = 640  
   The test statisiic  

...
$\chi^2_0 = \frac{(62-58.32)^2}{58.32}+\frac{(13-16.20)^2}{16.20}+\frac{(11-14.58)^2}{14.58}+\frac{(76-72.90)^2}{72.90}+\frac{(10-13.68)^2}{13.68}+\frac{(7-3.80)^2}{3.80}+\frac{(7-3.42)^2}{3.42}+\frac{(14-17.10)^2}{17.10}= 9.9689$

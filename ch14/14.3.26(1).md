...
|------------------------------------------------|-----------------------------------------------|-----------------------------------------------|--------------------------------------------------------------|
| $\hat{E}_{11}$ = $\frac{109*195}{346}$ = 61.43 | $\hat{E}_{12}$ = $\frac{109*89}{346}$ = 28.04 | $\hat{E}_{13}$ = $\frac{109*62}{346}$ = 19.53 | $\hat{E}_{11}$ = $\frac{109*195}{346}$ = 61.43 |
| $\hat{E}_{21}$ = $\frac{237*195}{346}$ = 133.57| $\hat{E}_{22}$ = $\frac{237*89}{346}$ = 60.96 | $\hat{E}_{23}$ = $\frac{237*62}{346}$ = 42.47 | $\hat{E}_{11}$ = $\frac{109*195}{346}$ = 61.43 |
